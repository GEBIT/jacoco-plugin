...
import hudson.plugins.jacocotransition.report.SourceAnnotator;
...
public class SourceAnnotatorTest {
    ...
    public void testSourceAnnotatorSimple() throws Exception {
        File file = new File("src/test/java/hudson/plugins/jacocotransition/report/SourceAnnotatorTest.java");
