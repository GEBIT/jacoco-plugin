...
import hudson.model.*;
import hudson.plugins.jacocotransition.JacocoHealthReportDeltaThresholds;
...
public class BuildOverBuildTest {
    ...
    public void checkBuildOverBuildFailureTest(){
        ...
        JacocoIntegrityTrendTransitionPublisher jacocoPublisher = new JacocoIntegrityTrendTransitionPublisher();
