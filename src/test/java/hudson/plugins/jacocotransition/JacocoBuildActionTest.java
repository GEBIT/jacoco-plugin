...
import hudson.plugins.jacocotransition.JacocoReportDir;
...
public class JacocoBuildActionTest extends AbstractJacocoTestBase {
    ...
    public void testConstruct() throws Exception {
        ...
        createDirectories(new File(testDir, "jacocotransition/classes").toPath());
        JacocoIntegrityTrendTransitionBuildAction r = JacocoIntegrityTrendTransitionBuildAction.load(null,
