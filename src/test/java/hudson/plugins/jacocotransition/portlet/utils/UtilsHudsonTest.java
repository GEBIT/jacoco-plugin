package hudson.plugins.jacocotransition.portlet.utils;
...
/**
 * Test {@link hudson.plugins.jacocotransition.portlet.utils.Utils}
...
public class UtilsHudsonTest extends HudsonTestCase {
  ...
  /**
   * Tests {@link hudson.plugins.jacocotransition.portlet.utils.Utils#getLastDate(java.util.List) }.
  ...
  /**
   * Tests {@link hudson.plugins.jacocotransition.portlet.utils.Utils#roundFloat(int scale, RoundingMode roundingMode, float value) }.
   */
