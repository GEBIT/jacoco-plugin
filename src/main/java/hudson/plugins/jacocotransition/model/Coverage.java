...
final public class Coverage implements Serializable {
    ...
    public String getCoveredStyle() {
    	return type.getReportType().getCoveredStr();
    }
    
    public String getMissedStyle() {
    	return type.getReportType().getMissedStr();
    }
    ...
    public int hashCode() {
        int result;
        result = missed;
        result = 31 * (result +type.ordinal() )+ covered ;
        return result;
    }
