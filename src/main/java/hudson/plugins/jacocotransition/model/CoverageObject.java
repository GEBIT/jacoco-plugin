...
import hudson.plugins.jacocotransition.Rule;
import hudson.plugins.jacocotransition.model.CoverageGraphLayout.Axis;
import hudson.plugins.jacocotransition.model.CoverageGraphLayout.CoverageType;
import hudson.plugins.jacocotransition.model.CoverageGraphLayout.CoverageValue;
import hudson.plugins.jacocotransition.model.CoverageGraphLayout.Plot;
import hudson.plugins.jacocotransition.report.AggregatedReport;
...
public abstract class CoverageObject<SELF extends CoverageObject<SELF>> {
	...
	public String printActivityTransitionCoverageColumns() {
		StringBuilder buf = new StringBuilder();
	//	instruction.setType(CoverageElement.Type.INSTRUCTION);
		clazz.setType(CoverageElement.Type.CLASS);
		//complexity.setType(CoverageElement.Type.COMPLEXITY);
	...
	public String printTwoCoverageColumns() {
		StringBuilder buf = new StringBuilder();
	//	instruction.setType(CoverageElement.Type.INSTRUCTION);
		clazz.setType(CoverageElement.Type.CLASS);
		//complexity.setType(CoverageElement.Type.COMPLEXITY);
	...
	public String printOneCoverageColumns() {
		StringBuilder buf = new StringBuilder();
	//	instruction.setType(CoverageElement.Type.INSTRUCTION);
	//	clazz.setType(CoverageElement.Type.CLASS);
		//complexity.setType(CoverageElement.Type.COMPLEXITY);
	...
	protected void printRatioTable(Coverage ratio, StringBuilder buf){
		...
		.append("<tr>")
		    ...
		    .append("<div class='percentgraph' style='width: ").append(greenBar).append("px; background-color:").
		    append(ratio.getCoveredStyle())
		    .append(";'>")
		    .append("<div class='percentgraph' style='width: ").append(redBar).append("px; background-color:").
		    append(ratio.getMissedStyle())
		    		 .append(";'>")
		    .append("</td></tr>")
		    .append("</table>");
	}
	 ...
	 */
	public void doGraph2(StaplerRequest req, StaplerResponse rsp) throws IOException {
		...
		CoverageGraphLayout layout = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis()
		.plot().type(CoverageType.LINE).value(CoverageValue.MISSED).color(Color.BLUE)
		.plot().type(CoverageType.LINE).value(CoverageValue.COVERED).color(Color.CYAN).axis();
	...
	public void doGraph(StaplerRequest req, StaplerResponse rsp) throws IOException {
		...
		CoverageGraphLayout layout = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis()
				.plot().type(CoverageType.METHOD).value(CoverageValue.MISSED).color(Color.RED)
				.plot().type(CoverageType.METHOD).value(CoverageValue.COVERED).color(Color.GREEN).axis()
		.plot().type(CoverageType.LINE).value(CoverageValue.MISSED).color(Color.BLUE)
		.plot().type(CoverageType.LINE).value(CoverageValue.COVERED).color(Color.CYAN).axis();
	...
	public void doGraphTransition(StaplerRequest req, StaplerResponse rsp) throws IOException {
		...
		/*
		CoverageGraphLayout layout1 = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis()
				.plot().type(CoverageType.METHOD).value(CoverageValue.MISSED).color(Color.RED)
				.plot().type(CoverageType.METHOD).value(CoverageValue.COVERED).color(Color.GREEN).axis();
		*/
		...
		CoverageGraphLayout layout = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis().reportType(ReportType.TRANSITION).axis();
	...
	public void doGraphActivity(StaplerRequest req, StaplerResponse rsp) throws IOException {
		...
		CoverageGraphLayout layout1 = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis()
				.plot().type(CoverageType.CLAZZ).value(CoverageValue.MISSED).color(Color.RED)
				.plot().type(CoverageType.CLAZZ).value(CoverageValue.COVERED).color(Color.GREEN).axis();
		*/
		CoverageGraphLayout layout = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis().reportType(ReportType.ACTIVITY).axis();
	...
	public void doGraphWorkflow(StaplerRequest req, StaplerResponse rsp) throws IOException {
		...
		/*
		CoverageGraphLayout layoutO = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis()
		.plot().type(CoverageType.LINE).value(CoverageValue.MISSED).color(ReportType.WORKFLOW.getMissed())
		.plot().type(CoverageType.LINE).value(CoverageValue.COVERED).color(ReportType.WORKFLOW.getCovered()).axis();
*/
		CoverageGraphLayout layout = new CoverageGraphLayout()
				.baseStroke(4f)
				.axis().reportType(ReportType.WORKFLOW).axis();
	...
	abstract class GraphImpl extends Graph {
		...
		{
			System.err.println("get GRAPH...");
			return createGraph();
		}
		
		public JFreeChart getGraph2( )
		{
			System.err.println("get GRAPH...");
			return createGraph();
		}
