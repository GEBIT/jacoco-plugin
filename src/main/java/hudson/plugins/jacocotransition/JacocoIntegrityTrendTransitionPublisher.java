...
import hudson.plugins.jacocotransition.portlet.bean.JacocoDeltaCoverageResultSummary;
import hudson.plugins.jacocotransition.portlet.utils.Utils;
 ...
 * 
 */
public class JacocoIntegrityTrendTransitionPublisher extends Recorder implements SimpleBuildStep {
    ...
    public JacocoIntegrityTrendTransitionPublisher() {
     ...
     */
    @Deprecated
    public JacocoIntegrityTrendTransitionPublisher(String execPattern, String classPattern, String sourcePattern, String inclusionPattern, String exclusionPattern, boolean skipCopyOfSrcFiles, String maximumInstructionCoverage, String maximumBranchCoverage
	...
	public String toString() {
		return "Trend Integrity Jacoco Publisher [execPattern=" + execPattern
    ...
    public static Result checkResult(JacocoIntegrityTrendTransitionBuildAction action) {
    ...
    @Extension @Symbol("jacocotransition")
    public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        public DescriptorImpl() {
            super(JacocoIntegrityTrendTransitionPublisher.class);
            setDescriptor(this);
        }

		@Override
        public String getDisplayName() {
            return Messages.JacocoIntegrityTrendTransitionPublisher_DisplayName();
        }
